...
file_id=file_id,
        ...
        try:
            ...
            await query.edit_message_text(text=f"- User notified successfully sweetie...✅\n\n⏳Status : Not Available 😒.\n🪪UserID : {user_id}\n🎞Content : {movie}\n\n\n🦋",reply_markup=reply_markup_lzdv)
...
await query.answer()
        ...
        try:
            ...
            btn_lzdv = [
                        [InlineKeyboardButton(text=f"♻ ‌R‌e‌q‌u‌e‌s‌t‌ ‌R‌e‌c‌i‌e‌v‌e‌d ♻", callback_data=f"notify_user_req_rcvd:{user_id}:{movie}")],
