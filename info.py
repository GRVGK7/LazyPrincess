...
PICS = (environ.get('PICS','https://graph.org/file/545ff17e641e74eceea0e.jpg')).split()
PRIME_LOGO = (environ.get('PRIME_LOGO', 'https://graph.org/file/545ff17e641e74eceea0e.jpg'))
...
QR_CODE_IMG = environ.get('QR_CODE_IMG','https://graph.org/file/545ff17e641e74eceea0e.jpg') #add url link of your qr code to recieve money - use telegraph bot or other source to get image
UPI_ID = environ.get('UPI_ID', 'grvgk7@oksbi') #enter your upi id here - grab it from your online payment methods.

# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/ams7group') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ams7group')
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','GRVGK7') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','ams7group') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','ams7group') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','ams7group')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "ams7group") #[ without @ ]
